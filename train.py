...
def main(CFG, data_path, batch_size, with_val=True):
    ...
    if with_val:
        ...
        val_loader = DataLoader(
            val_dataset, batch_size, shuffle=False, num_workers=1, pin_memory=True, drop_last=False)
    else:
        train_dataset = vessel_dataset(data_path, mode="training")
    train_loader = DataLoader(
        train_dataset, batch_size, shuffle=True, num_workers=1, pin_memory=True, drop_last=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dp', '--dataset_path', default="DATA_gu/training_pro", type=str,
