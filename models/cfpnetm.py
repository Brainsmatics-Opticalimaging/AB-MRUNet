...
def CFPNetM(height=256, width=256, channels=1):
    ...
    injection_1 = AveragePooling2D(pool_size=(2, 2))(inputs)
    ...
    injection_2 = AveragePooling2D(pool_size=(2, 2))(injection_1)
    ...
    injection_3 = AveragePooling2D(pool_size=(2, 2))(injection_2)
