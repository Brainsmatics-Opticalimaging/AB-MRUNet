...
def main(data_path, weight_path, CFG, show):
    ...
    loss = get_instance(losses, 'loss', CFG_ck)######ck
...
if __name__ == '__main__':
    ...
    parser.add_argument("-dp", "--dataset_path", default="DATA_gu/test_pro1", type=str,
                        help="the path of dataset")
    parser.add_argument("-wp", "--wetght_path", default="pretrained_weights/baseline/checkpoint-epoch49.pth", type=str,
